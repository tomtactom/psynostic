<ul>
	...
	<li><a href="<?php echo $options['siteurl']; ?>/backend/questionnaires.php">Fragebögen – Übersicht</a></li>
	<li><a href="<?php echo $options['siteurl']; ?>/backend/questionnaires.php#create-questionnaire-heading">Neuer Fragebogen</a></li>
	<li><a href="<?php echo $options['siteurl']; ?>/backend/questionnaire_items.php">Item-Builder</a></li>
