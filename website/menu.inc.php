	<ul>
		...
		<li><a href="<?php echo $options['siteurl']; ?>/questionnaires">Fragebögen (Übersicht)</a></li>
		<?php if (is_checked_in()) { ?>
		<li><a href="<?php echo $options['siteurl']; ?>/backend/results.php">Meine Auswertungen</a></li>
