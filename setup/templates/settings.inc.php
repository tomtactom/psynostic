		...
		<section>
			...
			<style>
				...
				<label for="inputUsername">Benutzername:*
					<input type="text" id="inputUsername" size="40" minlength="3" maxlength="32" name="username" placeholder="Benutzername" value="<?php echo htmlspecialchars($_POST['username'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" pattern="[A-Za-z0-9/_-]+" required>
				</label>
				<label for="inputFirstname">Vorname:*
					<input type="text" id="inputFirstname" size="40" minlength="3" maxlength="255" name="vorname" placeholder="Vorname" value="<?php echo htmlspecialchars($_POST['vorname'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" pattern="[a-zA-Z ]+" required>
				</label>
				<label for="inputLastname">Nachname:*
					<input type="text" id="inputLastname" size="40" minlength="3" maxlength="255" name="nachname" placeholder="Nachname" value="<?php echo htmlspecialchars($_POST['nachname'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" pattern="[a-zA-Z]+" required>
				</label>
				<label for="inputEmail">E-Mail:*
					<input type="email" id="inputEmail" size="40" maxlength="250" name="email" placeholder="E-Mail" value="<?php echo htmlspecialchars($_POST['email'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
				</label>
				...
				<label for="inputBiography">Biografie:
					<textarea id="inputBiography" maxlength="250" name="biography" placeholder="Biografie"><?php echo htmlspecialchars($_POST['biography'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
				</label>
				<label for="inputBirthday">Geburtsdatum:*
					<input type="date" id="inputBirthday" maxlength="10" name="birthday" placeholder="Geburtsdatum" value="<?php echo htmlspecialchars($_POST['birthday'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required>
				</label>
